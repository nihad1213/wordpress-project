    ...
    <div class="full-width-split group">
      <div class="full-width-split__one">
        <div class="full-width-split__inner">
          ...
          while ($homepage_events->have_posts()) : $homepage_events->the_post(); ?>
          ...
          <p class="t-center no-margin">
            <a href="<?= esc_url(get_post_type_archive_link('event')); ?>" class="btn btn--blue">View All Events</a>
          </p>
        </div>
      </div>
      ...
      <div class="full-width-split__two">
        <div class="full-width-split__inner">
          ...
          while ($blog_posts->have_posts()): $blog_posts->the_post(); ?>
            <div class="event-summary">
              ...
              <div class="event-summary__content">
                ...
                <?php the_excerpt(); ?>
                <p class="no-margin"><a href="<?php the_permalink(); ?>" class="nu gray">Read more</a></p>
              </div>
            </div>
          <?php endwhile;
          wp_reset_postdata();
          ...
          <p class="t-center no-margin"><a href="<?= esc_url(get_permalink(get_option('page_for_posts')) ?: home_url('/')) ?>" class="btn btn--yellow">View All Blog Posts</a></p>
        </div>
      </div>
    </div>
